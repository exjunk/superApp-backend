...
class StatusChecker:
    def __init__(self,timeout,dhan,order_id,correlation_id,dhan_feed,security_id,socket_id):
    ...
    def check_status(self):
        try:
            ...
            while not self.stop_event.is_set():
                ...
                server.send_message(message="test",client_id=self.socket_id)
